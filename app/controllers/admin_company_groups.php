...
class AdminCompanyGroups extends AppController
{
    ...
    private $client_group_fields = [
        ...
        'first_renewal_attempt_threshold', 'first_renewal_attempt_spacing',
    ...
    public function add()
    {
        ...
        $invoice_form_fields = [
            ...
            'renewal_attempt_spacing' => $select_fields->renewal_attempt_spacing,
    ...
    private function getSelectFields()
    {
        ...
        $fields->renewal_attempt_spacing = [Language::_('AdminCompanyBilling.invoices.text_none', true)];
        ...
        for ($i = 1; $i <= 72; $i++) {
            $fields->renewal_attempt_spacing[$i] = Language::_(
