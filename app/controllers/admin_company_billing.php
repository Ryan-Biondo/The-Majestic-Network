...
class AdminCompanyBilling extends AppController
{
    ...
    public function invoices()
    {
        ...
        $renewal_attempt_spacing = [Language::_('AdminCompanyBilling.invoices.text_none', true)];
        ...
        for ($i = 1; $i <= 72; $i++) {
            $renewal_attempt_spacing[$i] = Language::_(
        ...
        $form_fields = [
            ...
            'renewal_attempt_spacing' => $renewal_attempt_spacing,
